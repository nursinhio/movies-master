...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "211576@astanait.edu.kz", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "200428Nurs$", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "211576@astanait.edu.kz", "SMTP sender")
